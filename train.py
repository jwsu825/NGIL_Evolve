...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', type=str,
                        choices=["bare", 'gem', 'twp', 'jointtrain', 'ergnn', 'joint','Joint','ergnn-mmd','twp-mmd','gem-mmd'], default="ergnn",
                        )
    
    parser.add_argument('--SSRM', type=strtobool, default=True,
                        help='whether to include the proposed method SSRM')
    ...
    #command input
    method_args = {'ergnn': args.ergnn_args, 'twp': args.twp_args, 
                   'bare': args.bare_args, 'gem': args.gem_args,  'joint': args.joint_args}
